...
class laporan extends CI_controller
{
	...
	public function laporan_krisis($value='')
	{
	 $x = array('judul' =>'Laporan Data krisis Terdaftar',
	             'data'=>$this->m_laporan->krisis(),
	             'print'=>FALSE,);	
	 tpl('laporan/krisis',$x);	
	}

	 public function laporan_krisis_print($value='')
	{
	 $x = array('judul' =>'Laporan Data krisis Terdaftar',
	             'data'=>$this->m_laporan->krisis(),
	             'print'=>TRUE,);	
	 $this->load->view('laporan/krisis',$x);	
	}
    ...
    if (isset($_POST['cari'])) {
     ...
     $sampai=$this->input->post('sampai');
      $x=array(
      	     'judul'=>'Data Laporan Kehadiran krisis',
	...
	$x = array('judul' =>'Laporan Data Absensi Kinerja krisis',
               'depan'=>TRUE,
               'cetak'=>FALSE);	
	tpl('laporan/absensi',$x);
	}
	...
	$x = array('judul' =>'Laporan Data Tunjangan Pendapatan krisis',
